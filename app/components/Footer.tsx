...
export default function Footer() {
  return (
    <footer className="border-t border-surface-border bg-surface/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-7 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 sm:gap-10">
          {/* Brand */}
          <div className="col-span-2 md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 mb-2.5 sm:mb-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/logo2.png" alt="AstraCrea" className="h-8 sm:h-11 w-auto rounded-xl" />
        ...
        {/* ── Disclaimer légal ── */}
        <div className="mt-6 sm:mt-12 rounded-2xl border border-white/8 bg-white/[0.03] px-4 sm:px-6 py-3.5 sm:py-5">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <p className="text-white/38 text-[11px] sm:text-xs leading-relaxed line-clamp-4 sm:line-clamp-none">
        ...
        <div className="border-t border-surface-border mt-4 sm:mt-6 pt-4 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
