  ...
  return (
    <footer className="border-t border-surface-border bg-surface/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-3 sm:gap-10">
          {/* Brand */}
          <div className="col-span-2 md:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 mb-1.5 sm:mb-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/logo2.png" alt="AstraCrea" className="h-6 sm:h-11 w-auto rounded-lg sm:rounded-xl" />
              <span className="font-black text-sm sm:text-lg tracking-tight">Astra<span className="gradient-text">Crea</span></span>
            </Link>
            <p className="text-white/50 text-[11px] sm:text-sm leading-snug sm:leading-relaxed max-w-xs">
          ...
          {/* Links */}
          <div>
            <h4 className="font-semibold text-xs sm:text-base mb-1 sm:mb-4 text-white/80">Produit</h4>
            <ul className="space-y-0.5 sm:space-y-2">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-white/50 hover:text-white text-[11px] sm:text-sm transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-semibold text-xs sm:text-base mb-1 sm:mb-4 text-white/80">Légal</h4>
            <ul className="space-y-0.5 sm:space-y-2">
              {[
        ...
        {/* ── Disclaimer légal ── */}
        <div className="mt-3 sm:mt-12 rounded-xl sm:rounded-2xl border border-white/8 bg-white/[0.03] px-3 sm:px-6 py-2.5 sm:py-5">
          <div className="flex items-start gap-2 sm:gap-3">
            <div className="flex-shrink-0 mt-0.5">
              <AlertTriangle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white/35" />
            </div>
            <div className="space-y-1 sm:space-y-2">
              <p className="text-white/60 text-[9px] sm:text-xs font-semibold uppercase tracking-wider sm:tracking-widest">
                Avertissement — Limitation de responsabilité
              </p>
              <p className="text-white/38 text-[10px] sm:text-xs leading-snug sm:leading-relaxed line-clamp-3 sm:line-clamp-none">
        ...
        <div className="border-t border-surface-border mt-3 sm:mt-6 pt-3 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-1 sm:gap-4">
          <p className="text-white/30 text-[10px] sm:text-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4">
            ...
            <p className="text-white/20 text-[10px] sm:text-xs text-center">
